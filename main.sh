...
OpenClash() {
    cmdinstall "curl -L https://github.com/antifragile0/GeoSite-WRT/releases/download/latest/geoip.dat -o $OPENCLASH_DIR/GeoIP.dat" "Install GeoIP"
    cmdinstall "curl -L https://github.com/antifragile0/GeoSite-WRT/releases/download/latest/geosite.dat -o $OPENCLASH_DIR/GeoSite.dat" "Install GeoSite"
    cmdinstall "curl -L https://github.com/antifragile0/GeoSite-WRT/releases/download/latest/country.mmdb -o $OPENCLASH_DIR/Country.mmdb" "Install Country"

    cmdinstall "uci set openclash.config.geo_custom_url=https://github.com/antifragile0/GeoSite-WRT/releases/download/latest/country.mmdb" "Set Country"
	cmdinstall "uci set openclash.config.geosite_custom_url=https://github.com/antifragile0/GeoSite-WRT/releases/download/latest/geosite.dat" "Set GeoSite"
	cmdinstall "uci set openclash.config.geoip_custom_url=https://github.com/antifragile0/GeoSite-WRT/releases/download/latest/geoip.dat" "Set GeoIP"
...
Nikki() {
    cmdinstall "curl -L https://github.com/antifragile0/GeoSite-WRT/releases/download/latest/geoip.dat -o $NIKKI_DIR/GeoIP.dat" "Install GeoIP"
    cmdinstall "curl -L https://github.com/antifragile0/GeoSite-WRT/releases/download/latest/geosite.dat -o $NIKKI_DIR/GeoSite.dat" "Install GeoSite"
    cmdinstall "curl -L https://github.com/antifragile0/GeoSite-WRT/releases/download/latest/geoip.metadb -o $NIKKI_DIR/GeoIP.metadb" "Install GeoMeta"
	...
	cmdinstall "uci set nikki.mixin.geoip_mmdb_url=https://github.com/antifragile0/GeoSite-WRT/releases/download/latest/geoip.metadb" "Set GeoMeta URL"
	cmdinstall "uci set nikki.mixin.geoip_dat_url=https://github.com/antifragile0/GeoSite-WRT/releases/download/latest/geoip.dat" "Set GeoIP URL"
